...
class LSTMGATGCN(torch.nn.Module):
    ...
    def __init__(
        ...
        super(LSTMGATGCN, self).__init__()
    ...
    def _setup_layers(self):
        ...
        self._gat_layer = GATConv(in_channels=2*(self.out_channels),out_channels=self.out_channels)
    ...
    def forward(
        ...
        for period in range(self.periods):
            ...
            H_accum = H_accum + self._gat_layer(H,edge_index)
        return H_accum
